package com.pin.service.annotation;

import com.pin.domain.request.BaseRequest;
import com.pin.domain.response.BaseResponse;
import com.pin.service.CacheService;
import com.pin.service.util.ResponseUtil;
...
public class ParamCheckProcessor {
    ...
    @Around("@annotation(com.pin.service.annotation.ParamCheck)")
